...
(function () {
  ...
  window.ITEMS = {
    ...
    revolver: {
      ...
      photo: "icons/item-photos/revolver.png",
      quantity: 1,
    ...
    chainsword: {
      ...
      photo: "icons/item-photos/chainsword.png",
      quantity: 1,
    ...
    pulse_carbine: {
      ...
      photo: "icons/item-photos/pulse_carbine.png",
      quantity: 1,
    ...
    light_armor: {
      ...
      photo: "icons/item-photos/light_armor.png",
      quantity: 1,
    ...
    leather_jacket: {
      ...
      name: "Leather Jacket",
      icon: "icons/items/armor.svg",
      photo: "icons/item-photos/leather_jacket.png",
      quantity: 1,
